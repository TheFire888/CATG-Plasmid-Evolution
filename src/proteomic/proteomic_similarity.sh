...
diamond blastp -q "${WORKDIR}/proteins.faa" -d "${WORKDIR}/DMND_DB" -o "${WORKDIR}/DMND_BlastP.tsv" --ultra-sensitive --query-cover 50 --subject-cover 50 --quiet --outfmt 6 qseqid sseqid pident bitscore
