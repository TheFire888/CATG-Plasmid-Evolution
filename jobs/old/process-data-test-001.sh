...
#SBATCH --job-name=process-data-test-001
...
#SBATCH --output=process-data-test-001.out
#SBATCH --error=process-data-test-001.err

export PATH="/home/lleal/.pixi/bin:$PATH"

echo -e "\n## Job iniciado em $(date +'%d-%m-%Y as %T') ##\n"

cd "$SLURM_SUBMIT_DIR/../test/biotmp-qcMTC/"
pixi run python ../../src/proteomic/process_data.py eval gene_count.tsv M5-Graph.ftree filtered_DMBD_BlastP.tsv
